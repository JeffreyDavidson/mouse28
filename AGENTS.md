...
- Name working branches `<type>/<short-kebab-description>`, using `feature/`, `fix/`, `refactor/`, `chore/`, `docs/`, or `test/`; use `release/YYYY.MM.DD` for releases and `hotfix/<short-kebab-description>` for production fixes.
