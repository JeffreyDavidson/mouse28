<x-filament-widgets::widget>
    <div class="border-mouse-gold/20 from-mouse-navy to-mouse-purple via-mouse-navy-light relative overflow-hidden rounded-[1.25rem] border bg-linear-to-br p-6 sm:px-10 sm:py-8">
        ...
        <span class="text-mouse-gold-light/30 pointer-events-none absolute top-[15%] right-[15%] text-xs" aria-hidden="true">✦</span>
        <span class="text-mouse-gold-light/20 pointer-events-none absolute top-[60%] right-[25%] text-[0.6rem]" aria-hidden="true">✦</span>
        <span class="text-mouse-gold-light/25 pointer-events-none absolute right-[10%] bottom-[20%] text-base" aria-hidden="true">✦</span>
