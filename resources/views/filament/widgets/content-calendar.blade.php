    ...
    <div class="border-mouse-gold/15 from-mouse-navy/95 to-mouse-navy-light/90 relative h-full overflow-hidden rounded-[1.25rem] border bg-linear-to-br p-6">
        ...
        @if(count($items) === 0)
            <div class="px-4 py-8 text-center">
                ...
                <p class="font-mouse-body text-mouse-gold-light/60 text-sm">Schedule some magical content for the next 7 days.</p>
            </div>
        @else
            <div class="relative pl-6">
                ...
                @foreach($items as $item)
                    ...
                    @endphp
                    <a href="{{ $item['url'] }}" class="hover:bg-mouse-gold/5 relative block rounded-xl pb-4 no-underline transition-colors last:pb-0">
