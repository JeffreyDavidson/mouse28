    ...
    <div class="border-mouse-gold/15 from-mouse-navy/95 to-mouse-navy-light/90 relative h-full overflow-hidden rounded-[1.25rem] border bg-linear-to-br p-6">
        ...
        <form wire:submit.prevent="saveDraft">
            ...
            <div class="mt-4 flex justify-end">
                <button
                    type="submit"
                    class="font-mouse-body from-mouse-gold hover:shadow-mouse-gold/20 text-mouse-navy to-mouse-gold-light inline-flex min-h-12 items-center gap-1.5 rounded-xl bg-linear-to-br px-5 py-2.5 text-sm font-semibold transition hover:-translate-y-0.5 hover:shadow-lg"
                >
