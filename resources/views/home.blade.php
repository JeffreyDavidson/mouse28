    ...
    <div class="dispatch-cloth overflow-hidden">
        ...
        <section class="dispatch-blog-cluster relative z-10 px-4 pb-5 sm:px-6" data-dispatch-reveal="story-folio">
            <div class="mx-auto grid max-w-[86rem] items-start md:grid-cols-[8fr_12fr]">
                <div class="relative z-20 mx-auto mt-2 w-full max-w-lg md:mx-0 md:mt-0 md:w-[82%] md:max-w-none md:translate-x-4 md:-translate-y-8 md:-rotate-2 lg:translate-x-8 xl:translate-x-20">
                ...
                <div class="dispatch-latest-sheet relative z-10 mt-6 p-5 pt-7 sm:p-7 md:mt-0 md:ml-4 md:pl-14 lg:p-8 lg:pl-16">
