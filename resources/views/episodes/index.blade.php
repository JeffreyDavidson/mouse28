    ...
    <section class="bg-gradient-to-br from-navy to-navy-light py-16 md:py-24 relative overflow-hidden">
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 text-center relative z-10">
            ...
            <div class="flex items-center justify-center gap-3 mt-8">
                <a href="#" class="inline-flex items-center gap-2 bg-black/80 hover:bg-black text-white text-xs font-semibold px-4 py-2.5 rounded-xl transition-all hover:-translate-y-0.5 shadow-lg">
                ...
                <a href="#" class="inline-flex items-center gap-2 bg-[#1DB954] hover:bg-[#1ed760] text-white text-xs font-semibold px-4 py-2.5 rounded-xl transition-all hover:-translate-y-0.5 shadow-lg">
                            ...
                            <a href="/episodes/{{ $episode->slug }}" class="group block bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-navy/5 hover:border-purple/20 overflow-hidden">
                                <div class="flex flex-col sm:flex-row">
                                    ...
                                    <div class="relative flex-shrink-0 sm:w-28 h-20 sm:h-auto bg-gradient-to-br from-purple to-navy flex items-center justify-center">
                                        ...
                                        <div class="absolute bottom-1 left-1/2 -translate-x-1/2 flex items-end gap-[2px] h-4 opacity-40">
                                            <div class="w-[2px] bg-white rounded-full h-1 group-hover:animate-pulse"></div>
                                            <div class="w-[2px] bg-white rounded-full h-3 group-hover:animate-pulse" style="animation-delay:.1s"></div>
                                            <div class="w-[2px] bg-white rounded-full h-2 group-hover:animate-pulse" style="animation-delay:.2s"></div>
                                            <div class="w-[2px] bg-white rounded-full h-4 group-hover:animate-pulse" style="animation-delay:.3s"></div>
                                            <div class="w-[2px] bg-white rounded-full h-2 group-hover:animate-pulse" style="animation-delay:.15s"></div>
                                            <div class="w-[2px] bg-white rounded-full h-3 group-hover:animate-pulse" style="animation-delay:.25s"></div>
                                            <div class="w-[2px] bg-white rounded-full h-1 group-hover:animate-pulse" style="animation-delay:.35s"></div>
                                        </div>
                                    </div>
