                                ...
                                <div class="{{ !$loop->first ? 'mt-14' : '' }} mb-8">
                                    <div class="flex items-center gap-4">
                                        <div class="border-navy/5 flex items-center gap-3 rounded-full border bg-white px-5 py-2 shadow-sm">
                                            ...
                                            <span class="text-navy/65 text-sm">{{ $seasonEpisodes->count() }} {{ Str::plural('episode', $seasonEpisodes->count()) }}</span>
                                        </div>
                                        ...
                                        <div class="flex flex-col sm:flex-row">
                                            ...
                                            <div class="from-purple to-navy relative flex h-24 shrink-0 items-center justify-center bg-linear-to-br sm:h-auto sm:w-32">
                                                ...
                                                <div class="relative z-10 text-center transition-[transform,opacity] duration-300 group-hover:scale-90 group-hover:opacity-0">
                                                    <span class="block text-[10px] font-bold tracking-widest text-white/60 uppercase">EP</span>
                                                ...
                                                <div class="absolute inset-0 flex items-center justify-center opacity-0 transition-opacity duration-300 group-hover:opacity-100">
                                                    <div class="from-gold to-gold-light flex size-14 items-center justify-center rounded-full bg-linear-to-br shadow-lg">
                                                        @if ($episode->audio_source_url)
                                                            <svg aria-hidden="true" class="text-navy ml-0.5 size-6" fill="currentColor" viewBox="0 0 24 24"><path d="M8 5v14l11-7z" /></svg>
                                                        @else
                                                            <svg aria-hidden="true" class="text-navy size-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" /></svg>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="min-w-0 flex-1 p-5 sm:p-6">
                                                <div class="mb-2 flex flex-wrap items-center gap-3">
                                                    ...
                                                    @if ($episode->duration_seconds)
                                                        ...
                                                        <span class="text-navy/65 flex items-center gap-1 text-xs">
                                                            <svg aria-hidden="true" class="size-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                                                            {{ $episode->formatted_duration }}
                                                        </span>
                                                    @endif
                                                    @if ($episode->season_number)
                                                        <span class="text-navy/20">•</span>
                                                        <span class="text-navy/65 text-xs">S{{ $episode->season_number }}E{{ $episode->episode_number }}</span>
                                                    @endif
                                                </div>
                                                ...
                                                <div class="mt-4 flex items-center gap-4">
                                                    @if ($episode->apple_url)
                                                        <span class="bg-navy/5 text-navy/65 inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-xs">
                                                            <svg aria-hidden="true" class="size-3.5" viewBox="0 0 24 24" fill="currentColor"><path d="M18.71 19.5C17.88 20.74 17 21.95 15.66 21.97C14.32 22 13.89 21.18 12.37 21.18C10.84 21.18 10.37 21.95 9.1 22C7.79 22.05 6.8 20.68 5.96 19.47C4.25 16.56 2.93 11.3 4.7 7.72C5.57 5.94 7.36 4.86 9.28 4.84C10.56 4.81 11.78 5.7 12.56 5.7C13.34 5.7 14.85 4.62 16.41 4.8C17.07 4.83 18.96 5.06 20.16 6.87C20.05 6.95 17.58 8.37 17.61 11.34C17.65 14.9 20.68 16.04 20.71 16.06C20.69 16.13 20.18 17.86 18.71 19.5Z" /></svg>
                                                            Apple
                                                        </span>
                                                    @endif
                                                    @if ($episode->spotify_url)
                                                        <span class="bg-navy/5 text-navy/65 inline-flex items-center gap-1.5 rounded-full px-2.5 py-1 text-xs">
                                                            <svg aria-hidden="true" class="size-3.5" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.66 0 12 0zm5.521 17.34c-.24.359-.66.48-1.021.24-2.82-1.74-6.36-2.101-10.561-1.141-.418.122-.779-.179-.899-.539-.12-.421.18-.78.54-.9 4.56-1.021 8.52-.6 11.64 1.32.42.18.479.659.301 1.02zm1.44-3.3c-.301.42-.841.6-1.262.3-3.239-1.98-8.159-2.58-11.939-1.38-.479.12-1.02-.12-1.14-.6-.12-.48.12-1.021.6-1.141C9.6 9.9 15 10.561 18.72 12.84c.361.181.54.78.241 1.2z" /></svg>
                                                            Spotify
                                                        </span>
                                                    @endif
                                                    <span class="text-purple ml-auto flex items-center gap-1 text-sm font-medium transition-[gap] group-hover:gap-2">
                                                        ...
                                                        <svg aria-hidden="true" class="size-4 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" /></svg>
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="border-navy/5 rounded-2xl border bg-white p-6 shadow-sm">
                                ...
                                <div class="grid grid-cols-2 gap-4">
                                    <div class="from-purple/8 to-navy/5 rounded-xl bg-linear-to-br p-4 text-center">
                                        ...
                                        <span class="text-navy/65 mt-1 block text-xs font-medium tracking-wider uppercase">{{ Str::plural('Episode', $episodes->total()) }}</span>
                                    </div>
                                    <div class="from-gold/8 to-gold/3 rounded-xl bg-linear-to-br p-4 text-center">
                                        <span class="font-heading text-navy block text-3xl font-bold">{{ $totalHours }}<span class="text-navy/65 text-lg">h</span></span>
                                        <span class="text-navy/65 mt-1 block text-xs font-medium tracking-wider uppercase">Runtime</span>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <div class="min-w-0 flex-1">
                                                ...
                                                @if ($latestEpisode->duration_seconds)
                                                    <div class="mt-2 flex items-center gap-1.5">
                                                        <svg aria-hidden="true" class="text-navy/65 size-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
                                                        <span class="text-navy/65 text-xs">{{ $latestEpisode->formatted_duration }}</span>
                                                    </div>
                                                @endif
                                            </div>
                                        </div>
                            ...
                            <div class="from-navy via-navy-light to-navy relative overflow-hidden rounded-2xl border border-white/5 bg-linear-to-br p-7 text-center">
                                ...
                                <div class="relative">
                                    <div class="mx-auto mb-4 flex size-12 items-center justify-center rounded-xl border border-white/10 bg-white/10">
                                        <svg aria-hidden="true" class="text-gold size-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" /></svg>
                                    </div>
                    ...
                    <div class="relative z-10 mx-auto max-w-3xl">
                        <div class="grid items-center gap-12 md:grid-cols-2">
                            ...
                            <div class="text-center md:text-left">
                                ...
                                <p class="text-cream/60 mb-8 text-[0.95rem] leading-[1.8]">
                                ...
                                <div class="flex items-center justify-center gap-3 md:justify-start">
                                    @foreach ($podcast->distributionLinks() as $link)
                                        <a
                                            ...
                                            target="_blank"
                                            rel="noopener noreferrer"
                                            class="border-cream/10 bg-cream/8 text-cream/70 hover:border-gold/30 hover:text-gold inline-flex min-h-12 items-center gap-2 rounded-lg border px-4 py-2 text-base font-semibold transition-colors sm:text-xs"
                                        >{{ $link['label'] }}</a>
                                    @endforeach
                                </div>
                            </div>
                                ...
                                <div class="border-gold/12 bg-navy/60 rounded-3xl border p-8 shadow-2xl shadow-black/30 backdrop-blur-[10px]">
                                    ...
                                    <div class="mb-6 flex items-center gap-4">
                                        <div class="from-purple to-purple-dark shadow-purple/40 flex size-14 shrink-0 items-center justify-center rounded-xl bg-linear-to-br shadow-lg">
                                            <svg aria-hidden="true" class="text-gold size-[22px]" fill="currentColor" viewBox="0 0 24 24"><path d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z" /></svg>
                                        </div>
                                        <div class="flex-1">
                                    ...
                                    <div class="mt-4 flex items-center justify-center gap-6">
                                        <div class="flex size-7 items-center justify-center">
                                            <svg aria-hidden="true" class="text-cream/25 size-4" fill="currentColor" viewBox="0 0 24 24"><path d="M6 6h2v12H6zm3.5 6l8.5 6V6z" /></svg>
                                        </div>
                                        <div class="from-gold to-gold-dark shadow-gold/30 flex size-12 items-center justify-center rounded-full bg-linear-to-br shadow-lg">
                                            <svg aria-hidden="true" class="text-navy ml-0.5 size-5" fill="currentColor" viewBox="0 0 24 24"><path d="M8 5v14l11-7z" /></svg>
                                        </div>
                                        <div class="flex size-7 items-center justify-center">
                                            <svg aria-hidden="true" class="text-cream/25 size-4" fill="currentColor" viewBox="0 0 24 24"><path d="M6 18l8.5-6L6 6v12zM16 6v12h2V6h-2z" /></svg>
                                        </div>
                                    </div>
                                </div>
                            </div>
