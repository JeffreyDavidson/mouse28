    ...
    <div class="relative">
        ...
        <form action="{{ route('newsletter.store') }}" method="POST" class="space-y-3">
            ...
            <input
                ...
                class="focus:border-gold/40 focus:ring-gold/20 min-h-12 w-full rounded-xl border border-white/10 bg-white/8 px-4 py-3 text-base text-white transition-colors placeholder:text-white/25 focus:bg-white/12 focus:ring-2 focus:outline-none sm:text-sm"
            />
