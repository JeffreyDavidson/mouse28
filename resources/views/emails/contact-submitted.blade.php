                ...
                <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width: 600px; width: 100%;">
                    ...
                    <tr>
                        <td style="background: linear-gradient(135deg, #1a1040 0%, #2d1b69 60%, #3d2580 100%); border-radius: 16px 16px 0 0; padding: 32px 40px; text-align: center;">
                            ...
                            <h1 style="margin: 0; font-family: 'Besley', Georgia, serif; font-size: 24px; font-weight: 700; color: #ffffff; line-height: 1.3;">{{ $contactMessage->subjectLabel() }}</h1>
                        </td>
                    </tr>
                                        ...
                                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                <td align="right" valign="top">
                                                    <p style="margin: 0; font-size: 12px; color: #705f41; font-weight: 500;">{{ $contactMessage->created_at->format('M j, Y') }}</p>
                                                    <p style="margin: 2px 0 0; font-size: 12px; color: #705f41;">{{ $contactMessage->created_at->format('g:i A') }}</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
