...
@section('content')
    <section class="bg-gradient-to-br from-navy to-navy-light py-16 md:py-20 relative overflow-hidden">
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 text-center relative z-10">
            ...
            <p class="text-white/60 mt-4 max-w-xl mx-auto text-lg">Have a question, story to share, or want to collaborate? We'd love to hear from you.</p>
        </div>
    </section>
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6">
            @if(session('success'))
                <div class="max-w-2xl mx-auto bg-green-50 border border-green-200 text-green-800 rounded-2xl p-8 mb-8 text-center">
                    ...
                    <p class="text-sm mt-2 text-green-600">We'll get back to you as soon as we can.</p>
                </div>
            @endif
                ...
                <div class="lg:w-[40%] space-y-6">
                    ...
                    <div class="bg-white rounded-2xl p-6 shadow-sm border border-navy/5">
                        <div class="flex items-center gap-3 mb-4">
                            <div class="w-12 h-12 bg-purple/10 rounded-2xl flex items-center justify-center">
                                <svg class="w-6 h-6 text-purple" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                            </div>
                            <div>
                                <h3 class="font-heading font-bold text-navy">Email Us</h3>
                                <a href="mailto:hello@mouse28.com" class="text-purple text-sm hover:underline">hello@mouse28.com</a>
                            </div>
                        </div>
                        <div class="bg-cream rounded-xl p-3 flex items-center gap-2">
                            ...
                            <p class="text-navy/50 text-xs">We typically respond within <strong class="text-navy">24–48 hours</strong></p>
                        </div>
                    </div>

                    {{-- Social Links --}}
                    <div class="bg-white rounded-2xl p-6 shadow-sm border border-navy/5">
                        <h3 class="font-heading font-bold text-navy mb-4">Follow Along</h3>
                        <div class="space-y-3">
                            <a href="#" class="flex items-center gap-3 p-2 -mx-2 rounded-xl hover:bg-cream transition-colors group">
                                ...
                                <div>
                                    <p class="text-sm font-semibold text-navy group-hover:text-purple transition-colors">Instagram</p>
                                    <p class="text-xs text-navy/40">@mouse28disney</p>
                                </div>
                            </a>
                            ...
                            <a href="#" class="flex items-center gap-3 p-2 -mx-2 rounded-xl hover:bg-cream transition-colors group">
                                ...
                                <div>
                                    <p class="text-sm font-semibold text-navy group-hover:text-purple transition-colors">TikTok</p>
                                    <p class="text-xs text-navy/40">@mouse28</p>
                                </div>
                            </a>
                            ...
                            <a href="#" class="flex items-center gap-3 p-2 -mx-2 rounded-xl hover:bg-cream transition-colors group">
                                ...
                                <div>
                                    <p class="text-sm font-semibold text-navy group-hover:text-purple transition-colors">Facebook</p>
                                    <p class="text-xs text-navy/40">Mouse28 Disney</p>
                                </div>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="bg-gradient-to-br from-purple/5 to-gold/5 rounded-2xl p-6 border border-purple/10">
                        <h3 class="font-heading font-bold text-navy mb-3">Looking for something specific?</h3>
                        <div class="space-y-2">
                            <a href="/stories/share" class="flex items-center gap-2 text-sm text-navy/60 hover:text-purple transition-colors py-1">
                                <span>💛</span> Share your family's story
                            </a>
                            <a href="/guides" class="flex items-center gap-2 text-sm text-navy/60 hover:text-purple transition-colors py-1">
                                <span>📖</span> Browse accessibility guides
                            </a>
                            <a href="/episodes" class="flex items-center gap-2 text-sm text-navy/60 hover:text-purple transition-colors py-1">
                                <span>🎙️</span> Listen to the podcast
                            </a>
                            <a href="/blog" class="flex items-center gap-2 text-sm text-navy/60 hover:text-purple transition-colors py-1">
