@php($recovery = \App\Support\ErrorRecovery::for(request(), 419))
...
>
    <x-error-state
        ...
        message="For your security, the form expired before it was submitted. Reopen the form before trying again."
    >
