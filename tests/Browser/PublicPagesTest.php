...
test('blog filters and sorting animate stories without reloading or moving the controls', function (): void {
    ...
    $page
        ...
        ->assertScript(blogCardMotionObservedScript(), true)
        ->assertScript('(() => { const select = document.querySelector("#blog-sort").getBoundingClientRect(); const chevron = document.querySelector("[data-blog-sort-chevron]").getBoundingClientRect(); return select.right - chevron.right >= 15 && select.right - chevron.right <= 17; })()', true)
        ->resize(320, 812)
        ->assertScript('(() => { const select = document.querySelector("#blog-sort").getBoundingClientRect(); const chevron = document.querySelector("[data-blog-sort-chevron]").getBoundingClientRect(); return select.right - chevron.right >= 15 && select.right - chevron.right <= 17; })()', true)
        ->resize(768, 900)
        ->assertScript('(() => { const select = document.querySelector("#blog-sort").getBoundingClientRect(); const chevron = document.querySelector("[data-blog-sort-chevron]").getBoundingClientRect(); return select.right - chevron.right >= 15 && select.right - chevron.right <= 17; })()', true)
